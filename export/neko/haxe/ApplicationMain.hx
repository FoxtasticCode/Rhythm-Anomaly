...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Rhythm Anomaly", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Rhythm Anomaly", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Rhythm Anomaly";
		app.meta["name"] = "Rhythm Anomaly";
